...
def test_tree_len():
    tree = Tree(1)
    tree.add_node(TreeNode(3.1))
    tree.add_node(TreeNode(3.2))
    tree.add_node(TreeNode(3.3))
    assert len(tree) == 3
...
def test_add_node_treenode():
    tree_node = TreeNode(1)
    tree_node.add_node(TreeNode(3.1))
    tree_node.add_node(TreeNode(3.2))
    tree_node.add_node(TreeNode(3.3))
...
def test_treenode_len():
    treenode = TreeNode(1)
    treenode.add_node(TreeNode(3.1))
    treenode.add_node(TreeNode(3.2))
    treenode.add_node(TreeNode(3.3))
