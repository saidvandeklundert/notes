...
that the factory method is a method, and an abstract factory is an object. 
I think a lot of people get these two terms confused, and start using 
...
2:
The main difference between Abstract Factory and Factory Method is:
 - Factory Method is implemented by Inheritance.
 - Abstract Factory is implemented by Composition:
   - abstract factory is injected into the client 
"""
