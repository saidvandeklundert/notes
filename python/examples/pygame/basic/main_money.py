...
inputCaption = pygwidgets.DisplayText(
    window, (20, 150), "Input money amount:", fontSize=24, width=190, justified="right"
)
inputField = InputNumber(window, (230, 150), "", width=150, initialFocus=True)
okButton = pygwidgets.TextButton(window, (430, 150), "OK")

outputCaption1 = pygwidgets.DisplayText(
    window,
    (20, 300),
...
moneyField1 = DisplayMoney(
    window, (230, 300), "", textColor=BLACK, backgroundColor=WHITE, width=150
)

outputCaption2 = pygwidgets.DisplayText(
    window, (20, 400), "Output dollars only:", fontSize=24, width=190, justified="right"
)
moneyField2 = DisplayMoney(
    window,
    (230, 400),
    "",
    textColor=BLACK,
